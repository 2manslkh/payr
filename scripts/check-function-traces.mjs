...
let conflicts = 0;
let traces = 0;
const pdfEntries = new Set(["app/api/mcp/route.js.nft.json", "app/api/mcp/[token]/route.js.nft.json", "app/api/invoices/[id]/publish/route.js.nft.json", "app/api/jobs/publications/route.js.nft.json",

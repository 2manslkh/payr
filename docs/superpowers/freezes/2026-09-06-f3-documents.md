...
Native PDF tests run serially after the parallel unit group. Clean Linux runners required more than 30 seconds for the valid 18-page fixture even in isolation; inspection uses a bounded 45-second timer and awaits worker termination. This does not extend the frozen 60-second publication lease or relax any post-I/O fence, input, memory or proof check.

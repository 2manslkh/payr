...
it("previews all variants with width and format controls using sandboxed real HTML", () => {
  ...
  const frame = screen.getByTitle("Invoice email preview");
  ...
  const headings = ["Invoice from", "Payment Confirmed", "Payment Received", "Payment Confirmed", "Invoice from", "Payment Confirmed"];
